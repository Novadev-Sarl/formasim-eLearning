...
<template>
  <main class="flex flex-row w-screen h-screen">
    <!-- Left cover -->
    <div class="relative w-1/2 h-full bg-center bg-cover" :style="{ backgroundImage: `url(${LoginCover})` }">
      <div class="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b from-transparent to-black/80">
        <div
          ...
          <p>L'eLearning FormaSim, votre plateforme d'eLearning dédiée aux formations médicales spécialisées</p>
          <button class="text-white bg-black hover:bg-neutral-950 hover:shadow-md action">Demander un accès</button>
        </div>
      </div>
    </div>
    ...
    <div class="w-1/2">
      ...
      <div class="flex flex-col gap-8 p-24">
        ...
        <form class="flex flex-col gap-4" @submit.prevent="login">
          <div class="flex flex-col gap-2">
            ...
            <input type="email" id="email" v-model="email" class="w-full" placeholder="Entrez votre email">
          </div>

          <div class="flex flex-col gap-2">
            <label for="password">Mot de passe</label>
            <input type="password" id="password" v-model="password" class="w-full"
          ...
          <button type="submit" class="my-4 text-white action bg-primary disabled:opacity-50 disabled:cursor-auto"
      ...
      <div class="absolute bottom-0 px-24 pb-10 pt-18 bg-neutral-100">
        ...
        <p>
          Les formations en ligne de FormaSim vous permettent d'obtenir des certificats attestant de vos
          compétences.
          Cependant, elles ne remplacent pas les formations en présentiel, indispensables pour acquérir une pratique
          encadrée et validée par des experts.
        </p>
        ...
        <div class="flex flex-row justify-between gap-4 text-sm">
          <div class="flex flex-row gap-2 text-neutral-300">
            <a href="https://formasim.ch/fr/conditions-generales" class="text-primary">Conditions générales
              d'utilisation</a>
            <span>|</span>
            <a href="https://formasim.ch/fr/protection-des-donnees" class="text-primary">Protection des données</a>
          </div>
